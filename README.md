...
Coinbase is the largest US crypto exchange with 110+ million verified users. However, its revenue rises and falls with Bitcoin. This project quantifies that dependency and builds a data-driven framework for where Coinbase should diversify.


## Key Findings

- **Coinbase's revenue is strongly correlated with BTC8** Coinbase trading revenue falls and rises with BTC price. Correlation of 0.931 (2020-2022) and 0.728 (2023-2025). When Bitcoin drops, people stop thinking about Coinbase.
- **The problem is structural, not cyclical.** Even when BTC recovers to prior highs, trading revenue doesn't come back. Each crypto cycle brings fewer traders.
- **Trading fees still dominate revenue** despite 20+ product launches. The challenge isn't building products, but building products independent of BTC and shifting users to those products.
...
**The punchline:** Coinbase is already executing Track 2. My data suggests Track 1 is where the bigger strategic gap exists.
...
Weighted sensitivity analysis tests how rankings change under different strategic priorities (diversification, growth, customer demand, feasability).

## Interactive Dashboard

The Streamlit dashboard provides an exploration of all findings with 11 narrative sections.
